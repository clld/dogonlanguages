...
<ul>
<li>${h.external_link('http://doi.org/10.17617/2.2378140', label='Short grammar of Tiefo-N of Nyafogo (Gur, Burkina Faso)')}</li>
...
<ul>
<li>${h.external_link('http://doi.org/10.17617/2.2346932', label='A grammar of Jalkunan (Mande, Burkina Faso)')}</li>
